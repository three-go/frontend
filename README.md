...
- 전체 일정 : 2022 년 4 월 15 일 ~ 5 월 4 일 (약 3주)
...
[ FaceGo 개발 ] 2022 년 4 월 18 일 ~ 4 월 24 일 (7일)
...
[ ShoutGo 개발 ] 2022 년 4 월 25 일 ~ 5 월 4 일 (10일)
...
개발 초기에는 RN Game Engine의 각각의 엔티티들을 Matter.js에서 제공해주는 간단한 도형으로만 생성하였을 때 화면의 끊김 현상이 없었지만 각각 엔티티들의 이미지를 이용해서 생성했을때는 화면 끊김 현상이 발생하였습니다.
